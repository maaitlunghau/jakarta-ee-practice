...
<head>
    ...
    <title>Authentication Failed - Phone Library</title>
    <!-- Google Fonts -->
...
<body class="bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 min-h-screen flex items-center justify-center text-slate-100 p-4 relative overflow-hidden font-sans">
    ...
    <div class="absolute top-1/3 left-1/3 w-80 h-80 bg-red-600/10 rounded-full blur-[100px] pointer-events-none"></div>
    ...
    <div class="w-full max-w-[420px] z-10 animate-fade-in">
        <div class="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 md:p-10 shadow-2xl text-center">
            ...
            <div class="text-5xl text-red-500 mb-6 animate-bounce">
                ⚠️
            </div>
            ...
            <p class="text-slate-400 text-sm leading-relaxed mb-8">
                The username or password you entered is incorrect, or your account does not have admin privileges.
            </p>
